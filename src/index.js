...
const resourceObservable = new Observable();

// Add subscribers
resourceObservable.subscribe(logSubscriber);
resourceObservable.subscribe(notifySubscriber);
resourceObservable.subscribe(emailSubscriber);
resourceObservable.subscribe(databaseLogSubscriber);
...
app.post("/", (req, res) => {
	...
	resourceObservable.notify(newData);
